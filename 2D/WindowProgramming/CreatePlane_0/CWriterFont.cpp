...
void CWriterFont::ResetDevice(IDXGISurface* dxgiSurface)
{
...
void CWriterFont::Frame() {
	int k = 0;
}
void CWriterFont::DrawText(std::wstring msg, POINT pos)
{
	m_pd2dRT->BeginDraw();
